...
int WASDE(char** field, int& I1, int& J1, int& I2, int& J2, int& I3, int& J3, int& I4, int& J4, int sleep, int& Rand, int& pos, int& swap, bool& NoSleep, bool& GameOver, int** ColoursData, int level, int points, bool& Escape)
{
	...
	while (true)
	{
		...
		if (_kbhit())
		{
			...
			if (WASDE == 'w' && I1 < 2 && swap == 1 || WASDE == 'W' && I1 < 2 && swap == 1 || WASDE == '�' && I1 < 2 && swap == 1 || WASDE == '�' && I1 < 2 && swap == 1 || WASDE == 'w' && I2 < 2 && swap == 1 || WASDE == 'W' && I2 < 2 && swap == 1 || WASDE == '�' && I2 < 2 && swap == 1 || WASDE == '�' && I2 < 2 && swap == 1 || WASDE == 'w' && I3 < 2 && swap == 1 || WASDE == 'W' && I3 < 2 && swap == 1 || WASDE == '�' && I3 < 2 && swap == 1 || WASDE == '�' && I3 < 2 && swap == 1 || WASDE == 'w' && I4 < 2 && swap == 1 || WASDE == 'W' && I4 < 2 && swap == 1 || WASDE == '�' && I4 < 2 && swap == 1 || WASDE == '�' && I4 < 2 && swap == 1)
			{
				field[I1][J1] = '*';
				field[I2][J2] = '*';
				field[I3][J3] = '*';
			...
			if (WASDE == 'a' || WASDE == 'A' || WASDE == '�' || WASDE == '�')
			{
				bool BREAK{ false };
			...
			if (WASDE == 's' || WASDE == 'S' || WASDE == '�' || WASDE == '�')
			{
				NoSleep = true;
			}

			if (WASDE == 'd' || WASDE == 'D' || WASDE == '�' || WASDE == '�')
			{
				bool BREAK{ false };
			...
			if (WASDE == 'e' || WASDE == 'E' || WASDE == '�' || WASDE == '�')
			{
				switch (Rand)
				{
				case 5: break;
